...
def test(cfg: TrainPipelineConfig):
    ...
    weight_path = f"/gemini/platform/public/embodiedAI/users/ysy/data/train_cfn/cfn_cnn-single_task--prior-0902/{ckpt_task}-0902/model_epoch8.pt"
    ...
    # def yang_eval(cfg, model, task, task2, replace_action, is_train_data):
    # yang_eval(cfg, model, "block_handover", "block_handover", 0, 0)
