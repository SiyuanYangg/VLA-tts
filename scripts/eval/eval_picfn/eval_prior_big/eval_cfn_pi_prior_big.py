...
def test(cfg: TrainPipelineConfig):
    ...
    weight_path = f"/gemini/platform/public/embodiedAI/users/ysy/data/train_cfn/cfn_pi-single_task-newckpt-prior-big-0905-good/{ckpt_task}-0905/model_epoch8.pt"
