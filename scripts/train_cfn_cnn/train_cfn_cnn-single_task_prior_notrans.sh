...
do
    ...
    # Output directory
    OUTPUT_DIR="${data_root}/train_cfn/cfn_cnn-single_task-prior-notrans-0902/${task}-0902"
    ...
    cd ${code_root}/scripts/train_cfn_cnn
    # kernprof -l -v train2.py \
    python train_cfn_cnn_prior_notrans.py \
