...
do
    ...
    OUTPUT_DIR="${data_root}/train_cfn/cfn_pi-single_task-newckpt-sub-abs_action-0825/action25to50/${task}-0825"
    ...
    cd ${code_root}/scripts/train_cfn_sub
    # kernprof -l -v train2.py \
    python train_cfn_pi_sub.py \
