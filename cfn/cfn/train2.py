...
from cfn_net2 import CFNWrapper2
...
from cfn_dataset2 import cfn_lerobot_dataset2
...
def make_dataset(cfg: TrainPipelineConfig) -> cfn_lerobot_dataset2 | MultiLeRobotDataset:
    ...
    if isinstance(cfg.dataset.repo_id, str):
        ...
        val_dataset = cfn_lerobot_dataset2(
            cfg.dataset.repo_id,
            root=cfg.dataset.root,
