...
for task in \
    block_handover # block_handover #  container_place # diverse_bottles_pick  dual_bottles_pick_easy         
do
    echo now task = ${task} !!!
    ...
    # Output directory
    OUTPUT_DIR="${data_root}/dataset/feature_distance/${task}"
