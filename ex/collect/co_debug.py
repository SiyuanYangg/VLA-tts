...
def train(cfg: TrainPipelineConfig):
    ...
    weight_path = f'/gemini/platform/public/embodiedAI/users/ysy/data/train_cfn/cfn_pi-single_task-newckpt-prior-big-feature-step9-index14noise-0911/block_handover/model_epoch16.pt'
    # 加载训练好的权重
